...
<link rel="stylesheet" href="http://code.jquery.com/ui/1.9.0/themes/base/jquery-ui.css" />
    ...
    $(function() {
		...
		<title>Macheo::Mentor Registration</title>
	</head>
...
<section>
    ...
    <div id="tabs-3">
		...
		<form action="index.php" method="post">
				...
				<label id="">Surname</label><input type="text" name="txtsurname" id="txtsurname" class="defaultText" title="Enter Surname" />
				<label id="">Middle Name</label><input type="text" name="txtmiddlename" id="txtmiddlename" class="defaultText" title="Enter Middle Name" />
			    <label id="">First Name</label><input type="text" name="txtfirstname" id="txtfirstname" class="defaultText" title="Enter First Name" />
				<label id="">Middle Name</label><input type="text" name="txtmiddlename" id="txtmiddlename" class="defaultText" title="Enter Middle Name" />
